...
def gather_info():
    ...
    if datatype == 'synthetic':
        ...
        return (num_node, method, k, minc, datatype)
...
def run_synthetic(arguments):
    ...
    experiment = exp_synthetic(N, mu, k, maxk, minc, maxc, method, ground_truth_network_file, ground_truth_community_file, out_directory_path)
    experiment()
...
def main():
    ...
    if datatype == 'synthetic':
        ...
        for mu in mu_arrays:
            ...
            run_synthetic([N, mu, k, maxk, minc, maxc, method, ground_truth_network_file, ground_truth_community_file, out_directory_path])
